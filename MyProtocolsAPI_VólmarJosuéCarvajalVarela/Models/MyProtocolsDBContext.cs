...
namespace MyProtocolsAPI_VólmarJosuéCarvajalVarela.Models
{
...
//                optionsBuilder.UseSqlServer("SERVER=DESKTOP-5PAKN22\\SQLEXPRESS; DATABASE=MyProtocolsDB; INTEGRATED SECURITY=FALSE; USER ID=MyProtocolsAPIUser; PASSWORD=123456");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Protocol>(entity =>
            {
                ...
                entity.HasMany(d => d.ProtocolStepProtocolSteps)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("ProtocolProtocolId", "ProtocolStepProtocolStepsId").HasName("PK__Protocol__7C261295648C95AD");
            ...
            modelBuilder.Entity<ProtocolCategory>(entity =>
            {
                entity.HasKey(e => e.ProtocolCategory1)
                    .HasName("PK__Protocol__0ED5AEE51546E8FB");
            ...
            modelBuilder.Entity<ProtocolStep>(entity =>
            {
                entity.HasKey(e => e.ProtocolStepsId)
                    .HasName("PK__Protocol__C75F186EFB6D6E39");
